...
public class FtpMethodsController {
	...
	@ApiOperation(value = "Add FtpMethods", notes = "Add FtpMethods", response = ResponseEntity.class)
...
//			ExceptionCode exceptionCode = ftpMethodsWb.reviewRecord(vObject);
	...
	@ApiOperation(value = "Reject FtpMethods", notes = "Reject existing FtpMethods", response = ResponseEntity.class)
	...
	@ApiOperation(value = "Approve FtpMethods", notes = "Approve existing FtpMethods", response = ResponseEntity.class)
