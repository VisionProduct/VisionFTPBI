...
//			vObject.setRecordIndicator(-1);
	...
	/**
	 * All the methods handling the transactions should throw RuntimeException in
	 * order to rollback on failure.
	 * 
	 * @param vObjects
	 * @return
	 */
	...
	/*
	 * Table Columns Screen Add Functionality(Verification Required = NO) - an
	 * existing record will get updated when trying to add
	 */
	@Transactional(rollbackForClassName = { "com.vision.exception.RuntimeCustomException" })
