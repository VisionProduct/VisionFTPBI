...
public class ReportsVb extends CommonVb {
	...
	private List<ReportsVb> children;
	...
	private String ddKeyPromptLabel = "";
	private int freezeColumn = 0;
	private int maxRecPerPage = 100;
	private String reportPeriodFormat = "";
	private String vbdParamValue = "";
	...
	private String nextLevelColumnPrecision = "";
	...
	public List<ReportsVb> getChildren() {
		return children;
	}
	public void setChildren(List<ReportsVb> children) {
	...
	public String getDdKeyPromptLabel() {
		return ddKeyPromptLabel;
	}
	public void setDdKeyPromptLabel(String ddKeyPromptLabel) {
		this.ddKeyPromptLabel = ddKeyPromptLabel;
	}
	...
	public String getReportPeriodFormat() {
		return reportPeriodFormat;
	}
	public void setReportPeriodFormat(String reportPeriodFormat) {
		this.reportPeriodFormat = reportPeriodFormat;
	}
	public String getVbdParamValue() {
		return vbdParamValue;
	}
	public void setVbdParamValue(String vbdParamValue) {
		this.vbdParamValue = vbdParamValue;
	}
	...
	public String getNextLevelColumnPrecision() {
		return nextLevelColumnPrecision;
	}
	public void setNextLevelColumnPrecision(String nextLevelColumnPrecision) {
		this.nextLevelColumnPrecision = nextLevelColumnPrecision;
	}
	public String getMaskingColumns() {
		return maskingColumns;
	}
	public void setMaskingColumns(String maskingColumns) {
