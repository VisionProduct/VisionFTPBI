...
public class DashboardVb extends CommonVb implements Serializable{
	...
	private String savedDashboardTheme = "";
	...
	public String getSavedDashboardTheme() {
		return savedDashboardTheme;
	}

	public void setSavedDashboardTheme(String savedDashboardTheme) {
		this.savedDashboardTheme = savedDashboardTheme;
	}
