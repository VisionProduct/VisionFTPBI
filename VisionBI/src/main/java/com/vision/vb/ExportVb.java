...
public class ExportVb extends CommonVb{
	...
	private List<DashboardTilesVb> exportTilesDetLst = new ArrayList<>(); 
	private String applicationTheme = "";
	private String promptLabel = "";
	private String pdfGrwthWidth = "";
	private String tileType = "";
	private List tilePropAttr = null;
	private String exportImage = null;
	private String[] files = null;
	private Boolean exportFlag = false;
	private String tileSequence= "";
	...
	public String getPdfGrwthWidth() {
		return pdfGrwthWidth;
	}
	public void setPdfGrwthWidth(String pdfGrwthWidth) {
		this.pdfGrwthWidth = pdfGrwthWidth;
	}
	...
	public List getTilePropAttr() {
		return tilePropAttr;
	}
	public void setTilePropAttr(List tilePropAttr) {
		this.tilePropAttr = tilePropAttr;
	}
	public List<DashboardTilesVb> getExportTilesDetLst() {
		return exportTilesDetLst;
	}
	public void setExportTilesDetLst(List<DashboardTilesVb> exportTilesDetLst) {
		this.exportTilesDetLst = exportTilesDetLst;
	}
	...
	public String getTileSequence() {
		return tileSequence;
	}
	public void setTileSequence(String tileSequence) {
