...
public class ReportFilterVb extends CommonVb{
	...
	private String vbdEnable = "N";
	private String vbdParams = "";
	private String budgetFilter = "N";
	private String paramDelim = "_";
	private String paramPos = "";
	private String changeDefault = "N";
	...
	public String getVbdEnable() {
		return vbdEnable;
	}
	public void setVbdEnable(String vbdEnable) {
		this.vbdEnable = vbdEnable;
	}
	public String getVbdParams() {
		return vbdParams;
	}
	public void setVbdParams(String vbdParams) {
		this.vbdParams = vbdParams;
	}
	public String getBudgetFilter() {
		return budgetFilter;
	}
	public void setBudgetFilter(String budgetFilter) {
		this.budgetFilter = budgetFilter;
	}
	public String getParamDelim() {
		return paramDelim;
	}
	public void setParamDelim(String paramDelim) {
