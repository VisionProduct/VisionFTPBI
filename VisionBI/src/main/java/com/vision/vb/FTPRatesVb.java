...
public class FTPRatesVb extends CommonVb{
	...
	private String  debitPoolRate =  "";
	private String  creditPoolRate =  "";
	private int	poolRateStatusNt =  0;
	private int	poolRateStatus =  -1;
...
/*	private String oucAttribute= "";
	...
	public String getDebitPoolRate() {
		return debitPoolRate;
	}
	public void setDebitPoolRate(String debitPoolRate) {
		this.debitPoolRate = debitPoolRate;
	}
	public String getCreditPoolRate() {
		return creditPoolRate;
	}
	public void setCreditPoolRate(String creditPoolRate) {
		this.creditPoolRate = creditPoolRate;
	}
	public int getPoolRateStatusNt() {
		return poolRateStatusNt;
	}
	public void setPoolRateStatusNt(int poolRateStatusNt) {
		this.poolRateStatusNt = poolRateStatusNt;
	}
	public int getPoolRateStatus() {
		return poolRateStatus;
	}
	public void setPoolRateStatus(int poolRateStatus) {
		this.poolRateStatus = poolRateStatus;
	}
