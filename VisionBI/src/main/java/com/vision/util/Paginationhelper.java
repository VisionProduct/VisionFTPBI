...
public class Paginationhelper<E> {
	...
	public List<E> fetchPage(final JdbcTemplate jt, final String sqlFetchRows, final Object args[], final int startIndex, final int lastIndex,
	...
	public List<E> fetchPage(final JdbcTemplate jt, final String sqlFetchRows, final Object args[], final int startIndex, final int lastIndex, final Long totalRows,
			final RowMapper rowMapper) {
